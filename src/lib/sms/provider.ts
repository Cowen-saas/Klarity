 ...
 * via `SMS_MODE = mock | smspro` (cf. `src/lib/sms/index.ts`). Le provider réel
 * est SmsPro (`SmsProProvider`) — remplace Africa's Talking (cf.
 * `docs/PROGRESS.md`), qui remplaçait lui-même Orange SMS Cameroun (jamais
 * souscrit : sa propre FAQ documentait un problème de livraison vers MTN).
 *
